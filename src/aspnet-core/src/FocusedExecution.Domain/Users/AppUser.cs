...
namespace FocusedExecution.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update FocusedExecutionDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update FocusedExecutionEfCoreEntityExtensionMappings to extend the IdentityUser entity
